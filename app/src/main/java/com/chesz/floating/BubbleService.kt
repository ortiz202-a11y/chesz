...
val clamped = clampRootToScreen(startX + dx, startY + dy)
  ...
  private fun buildPanel(): FrameLayout {
    ...
    col.addView(space(dp(6)))
    col.addView(mkLine("Defensa fuck becerro asesino papaya sangrienta 80%"))    // Close: pegado abajo + icono centrado y sin recorte
    val closeH = dp(28) // mitad aprox / barra delgada
    ...
    val close = ImageView(this).apply {
      ...
      setBackgroundColor(0x66000000) // sutil para diferenciar
